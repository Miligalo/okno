        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="left-block">
                    <img src="./img/shippinggoods.jpeg" alt="IMG" class="img-fluid">
                </div>
                <h1 class="text-center"><strong>Оплата и доставка</strong></h1>
                <div class="text-content">
                    <p>
                        Доставка товара может осуществляться в пределах Одесского региона по следующим вариантам:
                    </p>
                    <ul class="list_del">
                        <li>Нашей компанией</li>
                        <li>Самовывозом</li>
                    </ul>
                    <hr>
                    <p>Оплата производится <i>безналичным, наличным расчетом или переводом на карту</i>.<br>Для быстрого оформления заказа и доставки, Вам необходимо связаться с нашим менеджером.</p>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form aaction="{{route('main.store')}}"  method="POST" class="pevie-home">
                    @csrf
                    <div class="input-name">
